...
// ************* THESE COMMENTS ARE FOR MAKING MOBILE DEVICES SHOW DARK MODE BY DEFAULT, I COMMENTED THEM OUT BECAUSE I WANT MOBILE TO ALSO OPEN WITH THE LIGHT THEME.
    
    // if (isMobileDevice()) {
    //     if ( parseInt(localStorage.getItem("toggleCount")) % 2 == 0 ) {
